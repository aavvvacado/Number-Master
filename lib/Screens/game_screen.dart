          ...
          BlocConsumer<GameBloc, GameState>(
            listener: (context, state) {
              if (state.status == GameStatus.won) {
                ...
                // (Optional: you could add a 'game_over.wav' sound here too)
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Game Over!'),
                    backgroundColor: Colors.red,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: GameGridWidget(
                          ...
                          hintCellIds: state.hintCellIds,
                          onCellTap: (cellId) {
                            // You could also add a tap sound here if you want
  ...
  Widget _buildGameButton({
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        label: Text(
          label,
          textAlign: TextAlign.center, // Good for the multi-line "Add Row" text
          style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
        ),
        style: ElevatedButton.styleFrom(
