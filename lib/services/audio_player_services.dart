...
class AudioService {
  ...
  // One player for long-running BGM
  final AudioPlayer _bgmPlayer = AudioPlayer();

  // --- FIX 1: One REUSABLE player for all short SFX ---
  ...
  void playTapSound() {
    ...
    // --- FIX 3: Use the reusable _sfxPlayer and fix volume ---
    _sfxPlayer.play(AssetSource('audio/button_click.mp3'), volume: 1.0);
  }

  void playLevelUpSound() {
    if (!_isSfxEnabled) return;

    // --- FIX 4: Use the reusable _sfxPlayer and fix volume ---
    _sfxPlayer.play(AssetSource('audio/victory_cheer.mp3'), volume: 1.0);
  }
  ...
  void dispose() {
    _bgmPlayer.dispose();
    // --- FIX 5: Dispose the sfxPlayer too ---
    _sfxPlayer.dispose();
  }
}
...
//     final AudioPlayer player = AudioPlayer();
//     player.setPlayerMode(PlayerMode.lowLatency);
//     player.play(AssetSource('audio/button_click.wav'), volume: 2.0);
//     player.onPlayerComplete.listen((event) {
//       player.dispose();
//     });
//   }
...
//     final AudioPlayer player = AudioPlayer();
//     player.setPlayerMode(PlayerMode.lowLatency);
//     player.play(AssetSource('audio/victory_cheer.wav'), volume: 2.0);
//     player.onPlayerComplete.listen((event) {
//       player.dispose();
//     });
//   }
